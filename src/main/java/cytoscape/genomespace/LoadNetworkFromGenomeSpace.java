...
public class LoadNetworkFromGenomeSpace extends AbstractCyAction {
	...
	public LoadNetworkFromGenomeSpace(DialogTaskManager dialogTaskManager, LoadNetworkFileTaskFactory loadNetworkFileTaskFactory, GSUtils gsUtils, JFrame frame) {
		super("Load Network...");
